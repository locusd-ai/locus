...
4. **`biem compact`** — remove tombstoned doc IDs from all bitmaps and registry

## Steps

### Step 1: Hierarchical tag flattening (biem-parser)
...
### Step 2: Cardinality-sorted intersection (biem-query)
...
### Step 3: JSON output flag (biem-cli)
...
- **Validate**: `biem search tag:work --json | jq .`
- **Commit**: `feat(cli): add --json flag for machine-readable output`

### Step 4: `biem compact` (biem-ingest)
...
- **Validate**: `cargo test && biem compact`
